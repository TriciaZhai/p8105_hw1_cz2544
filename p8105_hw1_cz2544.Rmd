...
The color scale for numerical vector is a contineous hugh. Although the vector in this case has only two values, it is processed as a contineous variable by r.
